// lib/presentation/screens/create_template_screen.dart
...
class _CreateTemplateScreenState extends ConsumerState<CreateTemplateScreen> {
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    this.setState(() {
                      _stages[stageIndex].tasks.add(TemplateTaskEntity(
                        taskName: taskName,
                        frequency: frequency,
  ...
  Future<void> _saveTemplate() async {
    ...
    try {
      ...
      await ref.read(templateServiceProvider).createTemplate(template);
