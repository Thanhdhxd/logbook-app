...
class QuickConfirmScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuickConfirmScreen> createState() => _QuickConfirmScreenState();
}

class _QuickConfirmScreenState extends ConsumerState<QuickConfirmScreen> {
  ...
  Future<void> _searchMaterials(String query) async {
    ...
    try {
      final results = await ref.read(materialServiceProvider).searchMaterials(query);
      setState(() {
